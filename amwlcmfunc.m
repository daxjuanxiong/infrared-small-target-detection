...
ry1 = 3;
rx1 = 3;
re1 = subfunc(img, ry1, rx1);
%% scale 2 3x4
ry2 = 3;
rx2 = 4;
re2 = subfunc(img, ry2, rx2);
%% scale 3 4x3
ry3 = 4;
rx3 = 3;
re3 = subfunc(img, ry3, rx3);
%% scale 4 4x4
ry4 = 4;
rx4 = 4;
re4 = subfunc(img, ry4, rx4);
if 1
    ...
    ry5 = 4;
    rx5 = 5;
    re5 = subfunc(img, ry5, rx5);
    %% scale 6 3x5
    ry6 = 3;
    rx6 = 5;
    re6 = subfunc(img, ry6, rx6);
    %% scale 7 5x3
    ry7 = 5;
    rx7 = 3;
    re7 = subfunc(img, ry7, rx7);
    %% scale 8 5x4
    ry8 = 5;
    rx8 = 4;
    re8 = subfunc(img, ry8, rx8);
    %% scale 9 5x5
    ry9 = 5;
    rx9 = 5;
    re9 = subfunc(img, ry9, rx9);
